...
import com.example.capstoneprojectfinalize.CustomerActivity;
...
public class ProductCustomerReservationActivityAdapter extends RecyclerView.Adapter<ProductCustomerReservationActivityAdapter.ViewHolder> {
    ...
    public ProductCustomerReservationActivityAdapter(Context context, List<ProductItem> productItems, UserItem userItem, String locationActivity) {
        mContext = context;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    reserveItem.setProductUserReservation(0);
                    reserveItem.setProductReversed(0);
